...
import { brandDesignSectionData } from "@/data/brand-scaling";
      ...
      <div className="flex flex-col lg:flex-row items-start gap-12 lg:gap-10 bg-[#E9F9F1] rounded-2xl p-8 lg:p-13 shadow-lg">
        ...
        >
          ...
          <div className="text-xs sm:text-base text-[#444] space-y-4 lg:max-w-xl leading-[1.07rem] sm:leading-7">
            <p>
              From truck wraps to signs, flyers, uniforms, and more—we design every customer-facing asset to build brand recognition and trust.
            </p>
            <p>
              Consistency across all materials builds recall and leads to more walk-ins, call-ins, and referrals.
            </p>
          </div>

          <div className="flex flex-col gap-x-8 gap-y-3 font-semibold text-left">
            {brandDesignSectionData.map((service, index) => (
