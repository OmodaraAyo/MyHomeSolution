...
import { prServiceSectionData } from "@/data/brand-scaling";

export default function PrServiceSection() {
  return (
    <section className="container mx-auto py-12 px-4 text-center items-center">
      <div className="flex flex-col lg:flex-row items-start gap-12 lg:gap-10 bg-[#FFEEFD] rounded-2xl p-8 lg:p-13 shadow-lg">
        ...
        >
          ...
          >
            Guest Posting & PR Services
          </p>

          <div className="text-xs sm:text-base text-[#444] space-y-4 lg:max-w-xl leading-[1.07rem] sm:leading-7">
            <p>
             Want to be seen as a leader in your space? We land you in high-authority blogs and media outlets that boost SEO, trust, and brand visibility.
            </p>
            <p>
          ...
          <div className="flex flex-col gap-x-8 gap-y-3 font-semibold text-left">
            {prServiceSectionData.map((service, index) => (
