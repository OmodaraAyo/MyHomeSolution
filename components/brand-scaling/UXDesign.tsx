...
import { uxDesignSectionData } from "@/data/brand-scaling";
      ...
      <div className="flex flex-col lg:flex-row items-start gap-12 lg:gap-10 bg-[#FFEEFD] rounded-2xl p-8 lg:p-13 shadow-lg">
        ...
        >
          ...
          <div className="text-xs sm:text-base text-[#444] space-y-4 lg:max-w-xl leading-[1.07rem] sm:leading-7">
            <p>
              As a branded home service business owner looking to establish dominance and build a centric digital presence from websites to mobile apps, leveraging professional UI/UX designs can help create intuitive, enjoyable, and efficient interactions for users, ensuring they have a positive experience with your brand.
            </p>
            <p>
              Looking to drive bookings via your personal business IOS/ Android mobile apps? Or make it easier for your customers to reach and make reservations for your services or purchase your products, A well perfected User Interface (UI) and User Experience (UX) design are critical components of any digital platform you need to launch to scale your business growth. 
            </p>
          </div>

          <div className="flex flex-col gap-x-8 gap-y-3 font-semibold text-left">
            {uxDesignSectionData.map((service, index) => (
