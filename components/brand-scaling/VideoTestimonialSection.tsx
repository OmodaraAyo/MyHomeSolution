...
import { videoTestimonialSectionData } from "@/data/brand-scaling";
      ...
      <div className="flex flex-col lg:flex-row items-start gap-12 lg:gap-10 bg-[#E9F9F1] rounded-2xl p-8 lg:p-13 shadow-lg">
        ...
        >
          ...
          <div className="text-xs sm:text-base text-[#444] space-y-4 lg:max-w-xl leading-[1.07rem] sm:leading-7">
            <p>
             We produce powerful video testimonials that build instant credibility and social proof.
            </p>
            <p>
              Let your happy customers sell for you—on your website, in your ads, and on social media.
            </p>
          </div>

          <div className="flex flex-col gap-x-8 gap-y-3 font-semibold text-left">
            {videoTestimonialSectionData.map((service, index) => (
