...
import { onlineOptSectionData } from "@/data/brand-scaling";

export default function OnlineOptSection() {
  return (
      ...
      <div className="flex flex-col lg:flex-row items-start gap-12 lg:gap-10 bg-[#EEF2FF] rounded-2xl p-8 lg:p-13 shadow-lg">
        ...
        >
          ...
          <div className="text-xs sm:text-base text-[#444] space-y-4 lg:max-w-xl leading-[1.07rem] sm:leading-7">
            <p>
              We manage your business listings across Google, Bing, Yelp,
              Facebook, Houzz, and more—so your business is visible, consistent,
              and fully optimized.{" "}
            </p>
            <p>
              If they search for your services in your city, they’ll find you first.
            </p>
          </div>

          <div className="flex flex-col gap-x-8 gap-y-3 font-semibold text-left">
            {onlineOptSectionData.map((service, index) => (
