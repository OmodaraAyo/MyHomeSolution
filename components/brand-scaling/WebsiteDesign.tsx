      ...
      <div className="flex flex-col lg:flex-row items-start gap-12 lg:gap-10 bg-[#FFF8E5] rounded-2xl p-8 lg:p-13 shadow-lg">
        ...
        >
          ...
          <div className="text-xs sm:text-base text-[#444] space-y-4 lg:max-w-xl leading-[1.07rem] sm:leading-7">
            <p>
              We design websites that don&apos;t just look good—they convert. Fast, mobile-first, and packed with lead-generating features, your site becomes a 24/7 sales machine.
            </p>
            <p>
              Strategically laid out, SEO-optimized, and easy to navigate, our websites are built for one goal: book more jobs.
            </p>
          </div>

          <div className="flex flex-col gap-x-8 gap-y-3 font-semibold text-left">
            {websiteDesignSectionData.map((service, index) => (
