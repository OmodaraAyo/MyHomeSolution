...
import { socialMediaMarketingData } from "@/data/digital-marketing";
      ...
      <div className="flex flex-col lg:flex-row items-start gap-12 lg:gap-10 bg-[#FFEEFD] rounded-2xl p-8 lg:p-13 shadow-lg">
        ...
        >
          ...
          <div className="text-xs sm:text-base text-[#444] space-y-4 lg:max-w-xl leading-[1.07rem] sm:leading-7">
            <p>
              Homeowners live on their phones—and they need to see you when they
              scroll. We turn your social presence into a lead-generating
              machine with engaging visuals, reputation-building content, and
              local promotions that spark trust.
            </p>
            <p>
              Stop posting just to post. Start building community, authority,
              and steady inquiries that turn into revenue.
            </p>
          </div>

          <div className="flex flex-col gap-x-8 gap-y-3 font-semibold text-left">
            {socialMediaMarketingData.map((service, index) => (
