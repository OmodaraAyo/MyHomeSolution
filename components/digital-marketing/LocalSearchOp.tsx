...
import { LocalSearchOpData } from "@/data/digital-marketing";

export default function LocalSearchOp() {
  return (
      ...
      <div className="flex flex-col lg:flex-row items-start gap-12 lg:gap-10 bg-[#FFEEFD] rounded-2xl p-8 lg:p-13 shadow-lg">
        ...
        >
          ...
          <div className="text-xs sm:text-base text-[#444] space-y-4 lg:max-w-xl leading-[1.07rem] sm:leading-7">
            <p>
              When someone searches “best HVAC near me” or “emergency plumber,”
              your business should be at the top. We optimize your Google
              Business Profile, local citations, and on-site SEO to make sure
              you show up where it counts—in your local area.
            </p>
            <p>
              This isn’t generic SEO. It’s revenue-generating visibility right
              when people are ready to book.
            </p>
          </div>

          <div className="flex flex-col gap-x-8 gap-y-3 font-semibold text-left">
            {LocalSearchOpData.map((service, index) => (
