...
import { leadGenerationSectionData } from "@/data/digital-marketing";
      ...
      <div className="flex flex-col lg:flex-row items-start gap-12 lg:gap-10 bg-[#EEF2FF] rounded-2xl p-8 lg:p-13 shadow-lg">
        ...
        >
          ...
          <div className="text-xs sm:text-base text-[#444] space-y-4 lg:max-w-xl leading-[1.07rem] sm:leading-7">
            <p>
              Say goodbye to guesswork and slow seasons. We build automated,
              high-converting lead funnels tailored for home service
              businesses—designed to capture, qualify, and convert leads at
              scale.
            </p>
            <p>
              Whether it&#39;s through landing pages, lead magnets, or follow-up
              systems, we help you consistently fill your pipeline with the
              right prospects—every single week.
            </p>
          </div>

          <div className="flex flex-col gap-x-8 gap-y-3 font-semibold text-left">
            {leadGenerationSectionData.map((service, index) => (
