...
import { adsSectionData } from "@/data/digital-marketing";
    ...
    <section className="container mx-auto py-12 px-4 text-center items-center">
      <div className="flex flex-col lg:flex-row items-start gap-12 lg:gap-10 bg-[#E9F9F1] rounded-2xl p-8 lg:p-13 shadow-lg">
        ...
        >
          ...
          >
            FB Ads & Retargeting Ads
          </p>

          <div className="text-xs sm:text-base text-[#444] space-y-4 lg:max-w-xl leading-[1.07rem] sm:leading-7">
            <p>
              Your ideal customers scroll Facebook and Instagram daily—and we
              make sure they stop on you. Our thumb-stopping ad creatives, laser
              targeting, and smart retargeting get your services seen and booked
              fast.
            </p>
            <p>
              Already had site visitors who didn’t convert? We’ll bring them
              back with precision retargeting ads that close the deal.
            </p>
          </div>

          <div className="flex flex-col gap-x-8 gap-y-3 font-semibold text-left">
            {adsSectionData.map((service, index) => (
