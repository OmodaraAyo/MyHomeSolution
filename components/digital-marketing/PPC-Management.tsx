...
import { ppcManageMentSectionData } from "@/data/digital-marketing";

export default function PPCManagementSection() {
  return (
    <section className="container mx-auto py-12 px-4 text-center items-center">
      <div className="flex flex-col lg:flex-row items-start gap-12 lg:gap-10 bg-[#FFF8E5] rounded-2xl p-8 lg:p-13 shadow-lg">
        {/* Text Content */}
        <motion.div
        ...
        >
          ...
          <div className="text-xs sm:text-base text-[#444] space-y-4 lg:max-w-xl leading-[1.07rem] sm:leading-7">
            <p>
              Need leads today? Our PPC strategies put your services in front of
              ready-to-buy customers immediately. Whether it’s Google Ads or
              Meta campaigns, we build performance-driven ads that convert
              clicks into calls, quotes, and bookings.
            </p>
            <p>
              No fluff. No wasted spend. Just high-converting campaigns with
              trackable ROI for every dollar spent—designed to dominate your
              local market.
            </p>
          </div>

          <div className="flex flex-col gap-x-8 gap-y-3 font-semibold text-left">
            {ppcManageMentSectionData.map((service, index) => (
