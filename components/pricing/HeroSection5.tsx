...
export default function HeroSection5() {
  return (
    <motion.section
      ...
      className="bg-primary text-white relative pt-[13rem] pb-[3rem] md:pt-[10rem] md:pb-[18rem] md:px-4 text-center"
    >
      ...
      <motion.div
        ...
        className="container mx-auto px-8 py-4 mt-9 text-left relative z-10 flex items-center"
      >
