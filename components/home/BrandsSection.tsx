...
export default function BrandsSection() {
  return (
    <section className="py-16 px-4 text-center container mx-auto ">
      <motion.h2
        initial={{ opacity: 0, y: 20 }}
        whileInView={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.6 }}
        viewport={{ once: true }}
        className="text-[29px] font-[600] text-[#333333] mt-2 marker:container mx-auto max-w-lg mb-8 text-center"
      >
