...
export default function ChampionsSection() {
  ...
  return (
    <section className="container mx-auto py-16 px-4 bg-white text-center mb-17">
      ...
      >
        <p className="text-lg font-[400] text-[#777777]">
      ...
      <div
        className="md:flex gap-6 min-w-[280px] marker:container mx-auto overflow-x-auto snap-x scrollbar-hide p-5"
        ref={scrollElement}
      >
        {championData.map((champion, index) => (
          ...
          >
            ...
            <Link
              href="/industries"
              className="mt-auto pt-4 text-[#1C3FAA] font-medium text-sm flex items-center  gap-2"
            >
      ...
      <div className="hidden md:flex w-fit ml-auto mt-8 items-center justify-center gap-2 px-2">
        <motion.button
          ...
          className="bg-[#F3F3F38F] text-white p-2 rounded-full flex items-center gap-2 shadow-lg shadow-[#f1f4fd] cursor-pointer"
        ...
        <motion.button
          whileTap={{ scale: 0.9 }}
          whileHover={{ scale: 1.1 }}
          className="bg-[#FFFFFF] text-white p-2 rounded-full flex items-center gap-2 shadow-lg shadow-gray-200 cursor-pointer"
