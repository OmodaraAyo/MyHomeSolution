...
import { bookingIntegrationSectionData } from "@/data/growth-marketing";

export default function BookingIntegrationSection() {
  return (
      ...
      <div className="flex flex-col lg:flex-row items-start gap-12 lg:gap-10 bg-[#EEF2FF] rounded-2xl p-8 lg:p-13 shadow-lg">
        ...
        >
          ...
          <div className="text-xs sm:text-base text-[#444] space-y-4 lg:max-w-xl leading-[1.07rem] sm:leading-7">
            <p>
             Say goodbye to phone tag and hello to effortless bookings. We integrate smart booking systems into your website and socials so customers can lock in appointments instantly.
            </p>
            <p>
              It’s fast, easy, and made to capture more jobs on the spot.
            </p>
          </div>

          <div className="flex flex-col gap-x-8 gap-y-3 font-semibold text-left">
            {bookingIntegrationSectionData.map((service, index) => (
