...
import { aIAnalysisSectionData } from "@/data/growth-marketing";
      ...
      <div className="flex flex-col lg:flex-row items-start gap-12 lg:gap-10 bg-[#E9F9F1] rounded-2xl p-8 lg:p-13 shadow-lg">
        ...
        >
          ...
          <div className="text-xs sm:text-base text-[#444] space-y-4 lg:max-w-xl leading-[1.07rem] sm:leading-7">
            <p>
             We use AI-powered tools to scan your competitors, track trends, and identify what’s working—then give you a playbook to beat them.
            </p>
            <p>
              You get smarter marketing strategies without the guesswork.
            </p>
          </div>

          <div className="flex flex-col gap-x-8 gap-y-3 font-semibold text-left">
            {aIAnalysisSectionData.map((service, index) => (
