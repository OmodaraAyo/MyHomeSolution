...
import { appointmentManagementSectionData } from "@/data/growth-marketing";

export default function AppointmentManagementSection() {
  return (
      ...
      <div className="flex flex-col lg:flex-row items-start gap-12 lg:gap-10 bg-[#FFF8E5] rounded-2xl p-8 lg:p-13 shadow-lg">
        ...
        >
          ...
          <div className="text-xs sm:text-base text-[#444] space-y-4 lg:max-w-xl leading-[1.07rem] sm:leading-7">
            <p>
             We make your calendar work smarter. Our system allows clients to see real-time availability, schedule appointments, reschedule, and get reminders—all without a single phone call.
            </p>
            <p>
              Your staff saves time, and your customers love the control.
            </p>
          </div>

          <div className="flex flex-col gap-x-8 gap-y-3 font-semibold text-left">
            {appointmentManagementSectionData.map((service, index) => (
