...
import { GridComponentProps } from "../types/types";
import useIsMobile from "@/hooks/useIsMobile";

const GridComponent = memo(function GridComponent(props: GridComponentProps) {
  const isMobile = useIsMobile();
  const { data, imgBgPrimaryColor, imgBgSecondaryColor} = props;
  return (
